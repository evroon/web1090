...
def store_routedata_virtualradar() -> None:
    ...
    for i, route in enumerate(routes):
        ...
        aggregated_route_data.append({
            ...
            'dep_country_id': data.get_country_id(route[16]),
            ...
            'arr_country_id': data.get_country_id(route[26]),
        })
...
def store_aircraftdata_aviationstack() -> None:
    ...
    while i < total:
        ...
        insert_in_table(cur, aircraftdata_columns, aggregated_data, AIRCRAFTDATA_DB, 'icao')
...
if __name__ == "__main__":
    ...
    if not table_exists(AIRCRAFTDATA_DB):
        ...
        store_aircraftdata()
    store_aircraftdata_aviationstack()
